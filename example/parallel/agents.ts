...
export const getAgents = (coinName: string) => {
  const blockchainDeveloper = new Agent({
    persona: {
      ...
      background: 'You specialize in developing smart contracts and dapps on the blockchain.',
  ...
  const blockchainSecurityExpert = new Agent({
    persona: {
      ...
      background: 'You specialize in securing smart contracts on the blockchain.',
